...
export declare class TrucksService {
    private mapmyIndia;
    private s3;
    constructor(mapmyIndia: MapmyIndiaService, s3: S3Service);
    ...
    uploadDocument(truckId: string, userId: string, file: Express.Multer.File, docType: 'RC' | 'Insurance', docNumber?: string): Promise<{
        document: {
            id: string;
    ...
    updateLocation(truckId: string, userId: string, address: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        userId: string;
