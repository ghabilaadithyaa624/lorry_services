...
async function runTests() {
  console.log('====================================================')
  console.log('  LORRYCARRY GPS REVERSE-GEOCODING & SEARCH SUITE  ')
  console.log('====================================================\n')
  ...
  console.log('--- TEST 1: MapmyIndiaService.reverseGeocode() with Chennai coordinates ---')
  ...
  console.log('  Reverse geocode output:', chennaiResult)
  ...
  console.log('\n--- TEST 2: Coordinate Boundary Validation (India bounding box) ---')
  ...
  console.log('\n--- TEST 3: SearchController.reverseGeocode() endpoint validation ---')
  try {
  ...
  console.log('  Controller endpoint output:', endpointResult)
  assert(
  ...
  console.log('\n--- TEST 4: Search Controller Accepts Real GPS Coordinates ---')
  ...
  console.log('\n--- TEST 5: Security Audit — No Mappls API Key Leaks in Frontend Code ---')
  ...
  if (securityLeaks.length === 0) {
    console.log('  ✅ No Mappls keys or direct Mappls API endpoints found in frontend bundle.')
    assert(true, 'Zero Mappls credentials exposed in frontend')
  } else {
    console.error('  Security leaks detected:', securityLeaks)
