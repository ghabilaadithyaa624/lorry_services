...
export default function HeroSection({
  ...
  return (
    <section className="relative min-h-[580px] lg:min-h-[640px] flex items-center justify-center overflow-hidden bg-slate-950 text-white">
      {/* Optimized LCP Background Image — next/image with priority */}
      <Image
        src={backgroundImageUrl}
        alt="Highway trucks on Indian freight corridor — LorryCarry direct freight network"
        fill
        priority
        fetchPriority="high"
        sizes="100vw"
        ...
        // decoding async is default for next/image; explicit for clarity
      />
          ...
          >
            ...
            >
              <path
                ...
                d="M8 7h8m-8 4h5m5 0a3 3 0 013 3v4a2 2 0 01-2 2h-1m-10 0H8a2 2 0 01-2-2V9a2 2 0 012-2h8a2 2 0 012 2v2m-6 9a2 2 0 100-4 2 2 0 000 4zm10 0a2 2 0 100-4 2 2 0 000 4z"
              />
            </svg>
