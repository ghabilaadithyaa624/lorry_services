 ...
 * Help & support.
 *
 * Static guidance plus real support channels. Deliberately contains no
 * ticketing UI, because the platform has no support-ticket backend — offering
 * one would imply functionality that does not exist.
 */
export default function HelpPage() {
  return (
    <DashboardLayout title="Help">
      <PageHeader
        title="Help & support"
        description="Answers to common questions, and how to reach a person when you need one."
